          ...
          <section className={styles.sentenceSection}>
            <div className={styles.sentenceBox}>
              ...
              <div className={styles.sentence}>
                <p>
                  当店では海外のビールを専門に取り扱い、ドイツ、フランス、メキシコ、イギリスなどの国のビールを中心に提供しています。当店はビール好きの方には必見のお店で、世界中から厳選した品揃えをお届けしています。私たちは、お客様に新しいビールの味わいを発見していただける場所となることを目指し、常に新しいビールの入荷やイベントなどを企画しています。是非一度、当店で世界のビールをお楽しみください。
                </p>
              </div>
            </div>
            <div className={styles.sentenceBox}>
